...
import com.jincomp.jintest.web.jin.mapper.TestMapper;
...
public class JinService {
	...
	public List<UploadVO> getUserList() { log.debug("JinService 진입>");
		List<UploadVO> mapper = testMapper.getImageList();
	...
	public Map saveFile(MultipartFile files) throws IOException {
		...
		//absolutePath log.debug("uploadPath >>>"+uploadPath);
